...
import { IListIndexProps } from "@/pages/productcategory/[...productcategory]";

export function ListProductcategory({ product }: IListIndexProps) {
  ...
  let query = router.query.productcategory[1];
    ...
    <Box mt={"20px"}>
      <Container maxWidth={"xl"} sx={{ width: "1300px" }}>
        <Header
          ...
          } > ${router.query.productcategory[2]}`}
        />
