...
import anh from "../../image/z3995513088064_b9373631618b48038d20b3b8bfeb27ed.jpg";
import Slider from "react-slick";
import Link from "next/link";
import { useRouter } from "next/router";

export interface ICSDProps {
  rolecsd: [
    {
      id: number;
      Rolename: string;
...
export function CSD({ rolecsd, productcsd }: ICSDProps) {
    ...
    <Box
      ...
      <Stack direction={"row"} justifyContent={"space-between"}>
        ...
        <Box width={846} overflow={"hidden"} position={"relative"}>
          ...
          <Link
            href={`/${productcsd[0].Category.categoryname}/${productcsd[0].category_id}`}>
            <Box
              mt={"20px"}
              display={"flex"}
              alignItems={"center"}
